...
io.write('\27[1;35m\n 📨┋Send UserName For Sudo : ارسل معرف المطور الاساسي ... \n\27[0;33;49m')
local SUDOID = io.read()
local GLOBLA = https.request("https://globla.gamemodsm.xyz/index.php?User=@"..SUDOID)
local Jsoninfo = JSON.decode(GLOBLA)
if Jsoninfo.Info.Chek == 'Not_Info' then
io.write('\27[1;35m\n The UserName was not Saved : المعرف خطأ ارسل المعرف صحيح \n\27[0;33;49m')
os.execute('lua GLOBLA.lua')
end
if Jsoninfo.Info == 'Channel' then
io.write('\27[1;35m\n 📡┋The UserName Is Channel : عذرا هاذا معرف قناة وليس حساب \n\27[0;33;49m')
os.execute('lua GLOBLA.lua')
end
if SUDOID ~= '' then
if Jsoninfo.Info.Id then
io.write('\27[1;36m Eddie was saved as the primary developer \n27[0;39;49m')
database:set(id_server..":SUDO:ID",Jsoninfo.Info.Id)
database:set(id_server..":SUDOUSER",Jsoninfo.Info.Username)
end
else
...
SUDOUSER = database:get(id_server..":SUDOUSER"),
 }
