...
local GLOBLA_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if GLOBLA_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
...
🔰┇Welcome to Globla source
      ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
↬   [Install source](https://t.me/GLOBLA/1001)

↬   [Channel Globla](http://t.me/GLOBLA)

↬   [Group Globla®](https://t.me/joinchat/GLOSYU6g4O3LbQTRqyEZxg)
...
t = "\n📃┋ قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(list) do  
local GLOBLA_Msg = database:get(bot_id.."Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..''..k..'- '..v..' » {'..GLOBLA_Msg..'}\n'    
end  
if #list == 0 then  
...
send(msg.chat_id_, msg.id_"👨‍✈️┋ تستطيع اضافهہ‌‏ صلاحيات {ادمن - مميز - عضو} \n🗣┋ ارسل الصلاحيه مجددا\n") 
return false
end
end
if text == 'ادمن' then
if not Manager(msg) then 
send(msg.chat_id_, msg.id_,"👨‍✈️┋ تستطيع اضافهہ‌‏ صلاحيات {مميز - عضو} \n🗣┋ ارسل الصلاحيه مجددا\n") 
return false
end
end
if text == 'مميز' then
if not Mod(msg) then
send(msg.chat_id_, msg.id_,"👨‍✈️┋ تستطيع اضافهہ‌‏ صلاحيات {عضو} \n🗣┋ ارسل الصلاحيه مجددا\n") 
return false
end
end
...
if num > 1000 then 
send(msg.chat_id_, msg.id_,'☑┋ تستطيع التنظيف ل1000 رسالهہ‌‏ كحد اقصى') 
return false  
end  
local msgm = msg.id_
for i=1,tonumber(num) do
...
send(msg.chat_id_, msg.id_,"\n✖┋ليس لديهہ‌‏ رتب حتى استطيع تنزيلهہ‌‏ \n")
end
...
send(msg.chat_id_, msg.id_,'✖┋ عذرا لا استطيع طرد ادمنية المجموعهہ‌‏') 
return false  
end
...
zainn = '['..(Get_Re_Name or '')..']'
zainm = '['..data.first_name_..']'
local zain ={ 
'\n شكو غيرت اسمك  يا حلو 😹🌚',
'\n شهل اسم الفيطي '..zainm.. ' \n رجعهہ‌‏ ؏ قديم \n '..zainn..'',
'\n  ها ها شو غيرت اسمك 🤔😹',
'\n شكو غيرت اسمك شنو قطيت وحدهہ‌‏ جديدهہ‌‏ 😹??🌚',
'\n شو غيرت اسمك شنو تعاركت ويهہ‌‏ الحب ؟😹🌞',
'\n ها ولك مو جان  اسمك   '..zainn..'  شكو غيرتهہ‌‏ ',
'\n شكو غيرت اسمك شسالفهہ‌‏ ؟؟ 🤔🌞'
}
...
--------------------------------------------------------------------------------------------------------------
local Getdatabase = database:get(bot_id.."Chen:User:Name"..msg.sender_user_id_)
if data.username_ then  
if Getdatabase and Getdatabase ~= data.username_ then 
zainn = '['..(database:get(bot_id.."Chen:User:Name"..msg.sender_user_id_) or '')..']'
local zain ={ 
'\n شكو غيرت معرفك  يا حلو 😹🌚',
'\n  ها ها شو غيرت معرفك 🤔😹',
'\n شكو غيرت معرفك شنو قطيت وحدهہ‌‏ جديدهہ‌‏ 😹😹🌚',
'\n شو غيرت معرفك شنو تعاركت ويهہ‌‏ الحب ؟😹🌞',
'\n ها ولك مو جان  معرفك   '..zainn..'  شكو غيرتهہ‌‏ ',
'\n شكو غيرت معرفك شسالفهہ‌‏ ؟؟ 🤔🌞'
}
send(msg.chat_id_,msg.id_,zain[math.random(#zain)])
...
------------------------------------------------------------------------
local GLOBLAbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if GLOBLAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"🗣┋المستخدم : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛┋["..GLOBLAbot.."] \n") 
